    ...
    public SketchBookAttributes() {
        ...
        attributeItemRequirements = configBuilder
                ...
                .defineList("attribute_item_requirements", Arrays.asList(
                        ...
                        "minecraft:wood_axe, strength, 10",
                        "minecraft:golden_axe, strength, 10",
                        "minecraft:stone_axe, strength, 15",
                        "minecraft:iron_axe, strength, 20",
                        "minecraft:diamond_axe, strength, 30",
                        "minecraft:netherite_axe, strength, 40",
